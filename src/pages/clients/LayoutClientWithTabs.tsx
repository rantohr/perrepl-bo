...
export default function LayoutClientWithTabs() {
  ...
  const currentOrderState: IOrder | undefined = state ? state.order : undefined;
  ...
  useEffect(() => {
    if (currentOrderState) {
      setCurrentOrder(currentOrderState);
    }
  }, [currentOrderState]);
            ...
            <div className="sidebar_layoutClientWithTabs w-[232px] h-[640px] bg-white rounded-lg p-4">
              ...
              <div className="description flex justify-center mt-4 flex-col items-center gap-1">
                <h4 className="font-bold text-violet-2 text-xs leading-[14.09px]">
                  {/* Annette Black */}
                  {currentOrder.order_creator.first_name}{" "}
                  {currentOrder.order_creator.last_name}
                </h4>

                <span className="grey-2 text-[10px]">
                  {/* #ID25858 */}
                  {currentOrder.id}
                </span>
              ...
              <div className="mt-4 flex flex-row items-center justify-center gap-2">
                <div>
                  <h4 className="text-10 text-grey-3 font-bold">
                    {/* B2B */}
                    {currentOrder.client_type}
                  </h4>
                </div>
              ...
              <div className="mt-4">
                ...
                <div className="flex flex-row gap-4 items-center">
                  ...
                  <div>
                    <span className="text-10 font-normal text-[#000000]">
                      {/* example@codeo.mg */}
                      {currentOrder.order_creator.email}
                    </span>
                  </div>
                </div>
                ...
                <div className="flex flex-row gap-4 items-center">
                  ...
                  <div>
                    <span className="text-10 font-normal text-[#000000]">
                      {/* (505) 555-0125 */}
                      {currentOrder.order_creator.phone_number}
                    </span>
                  </div>
                </div>
                  ...
                  items={[
                    {
                      ...
                      callback: () => {
                        navigate(
                          `/app/client/overview/view/${orderId}/general`,
                          {
                            state: {
                              order: currentOrder,
                            },
                    ...
                    },
                    {
                      ...
                      label: "Notes",
                      callback: () => {
                        navigate(`/app/client/overview/view/${orderId}/notes`, {
                          state: {
                            order: currentOrder,
                          },
                        });
                    ...
                    },
                    {
                      ...
                      label: "Trip",
                      callback: () => {
                        navigate(`/app/client/overview/view/${orderId}/trips`, {
                          state: {
                            order: currentOrder,
                          },
                        });
                    ...
                    },
                    {
                      ...
                      label: "Docs",
                      callback: () => {
                        navigate(`/app/client/overview/view/${orderId}/docs`, {
                          state: {
                            order: currentOrder,
                          },
                        });
  ...
  } else return "Chargement en cours ...";
}
